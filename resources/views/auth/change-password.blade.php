                ...
                <div class="d-flex justify-content-center align-items-center" style="height: 100vh;">
                    <form method="post" action="{{ route('change-password') }}" class="w-75">
                        ...
                        <div class="card card-style" style="background:#e6e6e6";>
                            ...
                            @enderror
                            <div class="card-body">
                                <p class="card-title mt-3" style="color: white;font-family:monospace;">Change New Password
                                </p>
                                <div class="card-text mt-5">
                                    ...
                                    <span class="fw-light text-muted" style="font-size: 12px;">*Password must be
                                        contained capital letter, small letter, special characters and numbers!</span>
